				...
				.WithEntityAccess())
		{
			...
			if (!character.ValueRO.IsBuildMode)
			{
				// show choosen gun
				{
					...
					{
						case 0:
							SystemAPI.SetComponentEnabled<MaterialMeshInfo>(characterEQ.ValueRO.WeaponSlot0, true);
							...
							break;
						case 1:
							SystemAPI.SetComponentEnabled<MaterialMeshInfo>(characterEQ.ValueRO.WeaponSlot0, false);

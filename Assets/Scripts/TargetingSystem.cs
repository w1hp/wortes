...
partial struct TargetingSystem : ISystem
{
	...
	{
		// NA SCENIE MUSI BYC MIN 9 OBIEKTOW Z EnemyComponent ZEBY UNITY SIE NIE DOSTALO CRASHA
		var targetQuery = SystemAPI.QueryBuilder().WithAll<LocalTransform, EnemyComponent>().WithNone<Target>().Build();
